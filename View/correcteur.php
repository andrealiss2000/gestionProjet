...
<html>
    ...
    <body>
        <div id="container">
            ...
            <form>
                <div id="numetu" class="form-group">
                    <label><b>Numéro étudiant : </b> </label>
                    <input type="identifiant" class="form-control2" placeholder="">
                </div>

                <div class="row" style="margin-top: 3vh">
                    <div class="form-group" style="margin-left: 13%" >
                        <label><b>D1 : </b></label>
                        <input type="number" id="note" class="form-control1"><span> /20</span>
                    </div>
                ...
                <div class="row">
                    <div class="form-group" style="margin-left: 14%" >
                        <label><b>1.1 : </b></label>
                        <input type="number" id="note" class="form-control1"><span> /5</span>
                    </div>
                    <div class="form-group">
                        <label><b>2.1 : </b></label>
                        <input type="number" id="note" class="form-control1"><span> /5</span>
