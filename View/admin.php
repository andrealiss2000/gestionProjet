        ...
        <div class="wrapper">
            ...
            <div id="addnew">
                ...
                <div class="form-group">
                    ...
                    <input type="prenom" class="form-control" placeholder="Entrez le prénom">
                </div>
                <div class="form-group">
                    <label><b>Nom :</b></label>
                    <input type="name" class="form-control" placeholder="Entrez le nom">
                </div>
                <div class="form-group">
                    <label><b>Identifiant :</b> </label>
                    <input type="identifiant" class="form-control" placeholder="Entrez l'identifiant">
                </div>
                <div class="form-group">
